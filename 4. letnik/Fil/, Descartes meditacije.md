...
Iz tega izpelje 3 stopnje dvoma. V prvi se navezuje na čute, za katere je kot omenjeno ugotovil, da so lahko varljivi. V drugi se vpraša kako lahko ločiti med budnostjo in sanjami. To razreši s tem, da obstajajo resnice, ki veljajo povsod, posebej pa se opre na matematične resnice (npr. kvadrat bo vedno imel 4 stranice). V tretji stopnji dvoma se Descartes sprašuje kaj, če obstaja zlobni duh, ki ga vara o vsem vključno s stvarmi, ki jih jemlje za gotove in resnice, za katere ve, da vedno veljajo npr. matematične resnice. Ta dvom ogroža vsakršno spoznanje, vendar ve da tudi, če ga zlobni duh vara to pomeni, da gotovo obstaja. Logično je nemogoče, da bi bil varan, da bi dvomil, mislil, ..., če ne bi obstajal. Zato iz tega sledi, da če misli potem tudi obstaja, kar je Descartesov slaven citat iz predhodnega dela Razprava o metodi "Mislim, torej sem." oz latinsko "Cogito, ergo sum." Tako dokaže, da Cogito oz. misleča stvar gotovo obstaja. To tudi v meditacijah (v slavni 8. točki 2. meditacije) zapiše na podoben način in pravi: "Kaj sem torej? Misleča stvar. Kaj je to? Stvar ki dvomi, ume, zatrjuje, zanikuje, hoče, noče, si tudi predstavlja in čuti", s čimer jasno definira cogito. To Descartesa pripelje v solipsizem, kar je prepričanje, da je le lastna zavest gotovo realna, vse ostalo pa je lahko iluzija ali nekakšna ustvarjena predstava. Da bi prišel iz solipsizma, je želel ustvariti kriterije za resnico. Zato je analiziral sam cogito. Spoznanje cogita je imelo določene lastnosti. Bilo je jasno, torej o tem ni mogel dvomiti. Bilo je razločno, torej čisto in ločeno od drugih idej. Zato Descartes za resnično razglasi to, kar je jasno in razločno.
...
- Objektivne realnosti so lastnosti **idej**.
